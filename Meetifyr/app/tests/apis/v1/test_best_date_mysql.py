...
class TestBestDatesMysql(TestCase):
    async def test_best_dates(self) -> None:
        ...
        async with httpx.AsyncClient(
            ...
            participant_response1_body = (
                participant_response1.json()
            )
            participant_response2_body = (
                participant_response2.json()
            )
            participant1_id = (
                participant_response1_body[
                    "participant_id"
            ...
            await asyncio.gather(
                client.patch(
                    ...
                    json={
                        "participant_date_id": participant_response1_body[
                            "participant_dates"
                        ][
                            2
                        ][
                ...
                client.patch(
                    url="/v1/mysql/participant_dates/on",
                    json={
                        "participant_date_id": participant_response2_body[
                            "participant_dates"
                        ][
                            2
                        ][
